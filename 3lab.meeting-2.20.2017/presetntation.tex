...
table[x =x,y =y,y error =yp,col sep = comma]{plotData/biomass-big-big-subplot-1};
\addplot+[
		  only marks, mark = triangle,
          error bars/.cd,
		  y explicit, y dir=both,
]
table[x =x,y =y,y error =yp,col sep = comma]{plotData/biomass-big-big-subplot-2};
\addplot+[
		  only marks, mark = square,
          error bars/.cd,
		  y explicit, y dir=both,
]
table[x =x,y =y,y error =yp,col sep = comma]{plotData/biomass-big-big-subplot-3};
\addplot+[
		  only marks, mark = diamond,
          error bars/.cd,
		  y explicit, y dir=both,
]
table[x =x,y =y,y error =yp,col sep = comma]{plotData/biomass-big-big-subplot-4};
\end{axis}
\end{tikzpicture}
\end{frame}
